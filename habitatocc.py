...
from utils import read_depth_image, read_depth_image_npy, read_semantic_image, \
                  ...
                  draw_occ_png, find_colormap_index, inverse_transform_coordinates
from colormap import colors_map

class HabitatOcc():
    def __init__(self, data_dir, is_generate_pointcloud=False, is_depth_npy=True, \
    ...
    def construct_occ(self):   
        ...
        self.merge_all_path = merge_all_path
    ...
    def save_local_occ(self):
        ...
        print("merge_ply_name:", merge_ply_name)
        ## ply是scannet坐标系下的，要先转换回去
        ...
        scene_voxels = inverse_transform_coordinates(scene_voxels)  ### 将点云转换到世界坐标系下
...
if __name__ == "__main__":
    habitatocc = HabitatOcc("example_data")
    habitatocc.construct_occ()
    # habitatocc.vis_local_occ()
    # habitatocc.vis_global_occ()
    # habitatocc.save_local_occ()
